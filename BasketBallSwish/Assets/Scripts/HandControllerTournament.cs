...
public class HandControllerTournament : MonoBehaviour {
    ...
    public PlayerControllerTournament playerController;
    ...
    void Update()
    {
        if (singlePlayerController.matchEnded)
        {
            ...
            this.botAntiRotateA = false;
            this.botAntiRotateB = false;
            this.rotateA = false;
            this.rotateB = false;
